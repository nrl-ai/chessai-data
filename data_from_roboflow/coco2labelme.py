            ...
            for inst_idx, (_, row) in enumerate(df.iterrows()):
                for polygon in row.shapes:
                    ...
                    copy_instance.update(
                        {"label": row["name"], "group_id": inst_idx, "points": polygon}
                    )
...
ds = CocoDatasetHandler(
    "data/Chinese Chess.v2i.coco/train/_annotations.coco.json",
    "data/Chinese Chess.v2i.coco/train",
)
ds.coco2labelme()
ds.save_labelme(ds.labelme.keys(), "data/data_02")

ds = CocoDatasetHandler(
    "data/Chinese Chess.v2i.coco/valid/_annotations.coco.json",
    "data/Chinese Chess.v2i.coco/valid",
)
ds.coco2labelme()
ds.save_labelme(ds.labelme.keys(), "data/data_02")

ds = CocoDatasetHandler(
    "data/Chinese Chess.v2i.coco/test/_annotations.coco.json",
    "data/Chinese Chess.v2i.coco/test",
)
ds.coco2labelme()
ds.save_labelme(ds.labelme.keys(), "data/data_02")
